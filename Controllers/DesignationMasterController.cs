...
namespace HMS.Controllers
{
    public class DesignationMasterController : Controller
    {
        ...
        public DesignationMasterController(IDesignationMasterServices DesignationMasterServices, ICommonService commonService)
        {
        ...
        public IActionResult Index(int currentPage = 1, string searchString = "", int PageSizeId = 10, string sortOrder = "Desc", string sortField = "Id")
        {
            var breadcrumbs = new List<Breadcrumb>
                {
                    ...
                    new Breadcrumb { Text = "Designation", Url = null },
            ...
            var res = _DesignationMasterServices.GetAll(ref TotalCount, currentPage, searchString, PageSizeId, sortField, ViewBag.SortOrder);
            ...
            var breadcrumbs = new List<Breadcrumb>
                {
                    new Breadcrumb { Text = "HMS", Url = null },
                    new Breadcrumb { Text = "Master", Url = null },
                    new Breadcrumb { Text = "Designation Master", Url = Url.Action("Index","DesignationMaster") },
